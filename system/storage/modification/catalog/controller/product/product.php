...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
            ...
            $this->document->setOpengraph('og:description', ($product_info['meta_description'] ? $product_info['meta_description'] : mb_substr(strip_tags(html_entity_decode($product_info['description'], ENT_QUOTES, 'UTF-8')),0,230)));
			}
			...
			$data['product_link'] = $this->url->link('product/product', 'product_id='.$product_info['product_id'], true);
